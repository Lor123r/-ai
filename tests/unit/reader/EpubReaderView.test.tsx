...
import EpubReaderView from '@renderer/reader/EpubReaderView'
import {
...
/** 假 epub.js：只保留 EpubReaderView 真正用到的那几个能力。 */
